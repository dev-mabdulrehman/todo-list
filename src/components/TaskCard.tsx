...
const TaskCard = ({ task, handleCheckChange, handleDeleteTask }: Props) => {
    ...
    return (
        <section className='flex items-center gap-2 bg-white p-4 rounded-md shadow-sm border border-black/10'>
            ...
            <section className='ml-auto gap-2 flex items-center'>
                <button onClick={onButtonClick} className='w-10 h-10 rounded-full hover:bg-gray-100 flex items-center justify-center'>
